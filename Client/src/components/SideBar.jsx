...
import { Eraser, FileText, Hash, House, ImageIcon, LogOutIcon, Scissors, SquarePen, Users } from 'lucide-react';
...
const SideBar = ({ sideBar, setSideBar }) => {
  ...
  return (
    <div className={`w-60 bg-white border-r border-gray-200 flex flex-col justify-betweenn items-center max-sm:absolute top-14 bottom-0 ${sideBar? 'translate-x-0' : 'max-sm:-translate-x-full transition-all duration-300 ease-in-out'}`}>
      ...
      <div className='w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between'>
        <div onClick={openUserProfile} className='flex gap-2 items-center cursor-pointer'>
          ...
          <div>
            ...
            <p className='text-xs text-gray-500'> <Protect plan='premium' fallback='Free'>Premium Plan</Protect> </p>
          </div>
        </div>
