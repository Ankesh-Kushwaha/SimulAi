  ...
  return !loading ?(
    <div className='flex-1 h-full flex flex-col gap-4 p-6'>
      ...
      <div className='bg-white h-full w-full rounded-xl overflow-y-scroll'>
        {
          creations.map((creation, index) => (<div className='relative group inline-block pl-3 w-full sm:max-w-1/2 lg:max-w-1/3' key={index}>
            <img src={creation.content} alt="" className='w-full h-full object-cover rounded-lg pt-3.5' />
